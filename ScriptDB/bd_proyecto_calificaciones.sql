...
CREATE TABLE `calificaciones` (
  ...
  KEY `fk_autorCalificacion_idx` (`idAutor`),
  KEY `fk_cancionCalificacion_idx` (`idCancion`),
  CONSTRAINT `fk_autorCalificacion` FOREIGN KEY (`idAutor`) REFERENCES `usuarios` (`idUsuario`),
