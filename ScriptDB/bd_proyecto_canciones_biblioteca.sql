...
--
-- Table structure for table `canciones_biblioteca`
--

DROP TABLE IF EXISTS `canciones_biblioteca`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `canciones_biblioteca` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idBiblioteca` int NOT NULL,
  `idCancion` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_bibliotecaPertCancion_idx` (`idBiblioteca`),
...
--
-- Dumping data for table `canciones_biblioteca`
--

LOCK TABLES `canciones_biblioteca` WRITE;
/*!40000 ALTER TABLE `canciones_biblioteca` DISABLE KEYS */;
/*!40000 ALTER TABLE `canciones_biblioteca` ENABLE KEYS */;
UNLOCK TABLES;
